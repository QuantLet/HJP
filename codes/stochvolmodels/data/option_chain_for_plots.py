...
def get_plot_chain_data() -> OptionChain:
       N_options_ttm = 20
       ...
       bid_ivs = (array([0]*N_options_ttm))*4
       ask_ivs = (array([0]*N_options_ttm))*4

       strikes_ttms = tuple([(np.linspace(Moneyness_range[0], Moneyness_range[1], int(N_options_ttm/2))) for _ in range(4)])
